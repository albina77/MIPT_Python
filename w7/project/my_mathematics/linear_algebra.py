class Vector:
    ...
    def __str__(self):
        return '({}, {}, {})'.format(str(self.__x), str(self.__y), str(self.__z))
    ...
    def __eq__(self, other):
        if all([self.__x == other.__x, self.__y == other.__y, self.__z == other.__z]): # как я поняла, все наши векторы имеют начало в нуле
            return True
        return False
